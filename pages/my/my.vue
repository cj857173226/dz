	...
	<view id="my-index">
		<div id="my-index-head" class="clearfix">
			...
			<div class="avatar-right-wrap">
				<p id="user-cname" v-text="userInfo.username?userInfo.username:'请登录'"></p>
				<!--完善信息-->
		  ...
		  <div id="my-index-main">
                ...
                <div class="ad-wrap " id="slider">
                   <swiper class="swiper" circular=true :indicator-dots="indicatorDots" :autoplay="autoplay" :interval="interval" :duration="duration" :indicator-active-color="indicatorActiveColor">
                        <swiper-item>

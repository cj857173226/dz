		...
		<view class="edit_address_wrap">
			<view class="edit_address_form">
				...
				<view class="form-item">
					...
					<view class="input">
						<input type="text" placeholder-style="font-size:14px;color:#cccccc;" placeholder="详细地址" v-model.tirm="addressForm.local">
					</view>
				</view>
				<view class="form-item">
			...
			<view class="handle_btn_wrap">
				<button class="my-btn-block add-btn">添加</button>
			</view>
		</view>
